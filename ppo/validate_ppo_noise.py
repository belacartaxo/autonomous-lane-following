...
MODEL_PATH = "./models/ppo_noise/ppo_noise_final"
...
with open("./results/c2_noise_ppo.json", "w") as f:
    json.dump(results, f, indent=2)

print("\nResultados guardados em ./results/c2_noise_ppo.json")